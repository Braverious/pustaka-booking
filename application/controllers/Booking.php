...
class Booking extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('template/template-user/header', $data);
        $this->load->view('booking/data-booking', $data);
        $this->load->view('template/template-user/modal');
        $this->load->view('template/template-user/footer');
    }
    ...
    {
        // Update stock and booking status in the book table when booking process is completed
        ...
        // Save data to the booking table and detail booking, and empty the temporary table
    ...
    public function info()
    {
        ...
        $data['items'] = $this->db->query("SELECT * FROM booking bo, booking_detail d, buku bu 
                                       WHERE d.id_booking = bo.id_booking AND 
                                             d.id_buku = bu.id AND 
                                             bo.id_user = '$where'")->result_array();
    ...
    public function exportToPdf()
    {
        ...
        // Load the view file and get the rendered HTML
